...
1. **Follow our design guidelines**
	...
	* The [package design guidelines](https://confluence.hq.unity3d.com/display/UX/Packages) on Confluence.
...
The validation suite is still in preview, so if you come across arguable results, please discuss them on **#devs-packman-tooling**.
